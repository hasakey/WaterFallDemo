...
//  WaterFallDemo
//
//  Created by 喂！ on 2019/1/10.
//  Copyright © 2019年 well. All rights reserved.
//

#import "WaterFallNormalVC.h"

@interface WaterFallNormalVC ()<UICollectionViewDelegate, UICollectionViewDataSource>
{
    WaterFlowLayout * _flow;
    NSMutableArray * _array;
}

@end

@implementation WaterFallNormalVC
...
- (void)viewDidLoad {
    ...
    _flow = [[WaterFlowLayout alloc] init];
    _flow.delegate = self;
